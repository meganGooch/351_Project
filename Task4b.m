...
%create the plot
syms x;
y = piecewise((x<start_distance), 0,(start_distance<x)&(x<start_distance+threshold_width), (threshold_height*sin(pi/threshold_width*(x-start_distance)).^2), (x>start_distance+threshold_width)&(x<floor_length), 0);
fplot (x,y)
